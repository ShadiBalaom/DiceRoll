...
export const AtomIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12,2 C6.477,2 2,6.477 2,12 C2,17.523 6.477,22 12,22 C17.523,22 22,17.523 22,12 C22,6.477 17.523,2 12,2 Z"></path>
        <ellipse cx="12" cy="12" rx="5" ry="10" transform="rotate(45 12 12)"></ellipse>
        <ellipse cx="12" cy="12" rx="5" ry="10" transform="rotate(-45 12 12)"></ellipse>
    </svg>
);
...
export const BeakerIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4 3h16M7 3v2.428A5.002 5.002 0 009.5 9.553V21h5V9.553a5.002 5.002 0 002.5-4.125V3M7 9h10"></path>
    </svg>
);
